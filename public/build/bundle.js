...
var app = (function () {
    ...
    /* src\components\TestComponent.svelte generated by Svelte v3.29.0 */

    const file = "src\\components\\TestComponent.svelte";
    ...
    function instance($$self, $$props) {
    	...
    	validate_slots("TestComponent", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<TestComponent> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class TestComponent extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\modules\TestModule.svelte generated by Svelte v3.29.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	let testcomponent;
    	let current;
    	testcomponent = new TestComponent({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 25, 2, 1148);
    			attr_dev(div, "class", "content");
    			add_location(div, file$1, 24, 0, 1123);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$2, 25, 0, 1106);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
