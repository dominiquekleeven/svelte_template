...
var app = (function () {
    ...
    /* src\components\component_template.svelte generated by Svelte v3.29.0 */

    const file = "src\\components\\component_template.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h3 = element("h3");
    			h3.textContent = "Hello Component";
    			add_location(h3, file, 7, 4, 88);
    			attr_dev(div, "class", "content");
    			add_location(div, file, 6, 0, 61);
    		},
    ...
    function instance($$self, $$props) {
    	...
    	validate_slots("Component_template", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Component_template> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class Component_template extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(component_template.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(component_template.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			destroy_component(component_template);
    		}
    	};
    ...
    /**
      ...
      var hasProcess = typeof {"env":{"isProd":false,"API_URL":"https://mowave.kbnet.xyz/api/v1"}} !== 'undefined';
